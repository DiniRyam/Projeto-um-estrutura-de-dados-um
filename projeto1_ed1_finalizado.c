...
void gerarListaEstoque(ItemEstoque *estoque, int num_itens)
{
    ...
    fprintf(arquivo, "-- Lista de Itens do Estoque em Ordem Alfab�tica --\n");
    for (int i = 0; i < num_itens; i++)
    {
...

{
    ...
    while (1)
    {
        ...
        {
            printf("\nO email � inv�lido, ele deve conter '@' pra ser um email v�lido.\n");
        }
    }
    ...
    printf("\nCadastro concluido, fa�a login para continuar.\n");
                ...
                case 1:
                    while (1)
                    {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            printf("\nEscolha a conta que ser� removida:\n");
                            for (int i = 0; i < num_emails; i++)
                            {
                                printf("%d. %s\n", i + 1, lista_emails[i]);
                            }
                            ...
                            {
                                printf("EOp��o inexistente\n");
                            }
                            break;
                        case 4:
                            break;
                        default:
                            printf("Op��o inexistente. Escolha uma op��o dispon�vel.\n");
                            break;
                        }
                        if (escolha == 4)
                            break;
                    ...
                    while (1)
                    {
                        ...
                        case 3:
                            ...
                            else
                            {
                                ...
                                printf("Digite o n�mero correspondente ao item que deseja remover: ");
                                int escolha_item;
